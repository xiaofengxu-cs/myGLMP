        ...
        for line in fin:
            ...
            if line:
                ...
                if '\t' in line:
                    ...
                    # 局部指针标签：回复中对应位如果是实体词则标记在对话信息的位置，标签中每个数字代表在对话历史中的位置
                    for key in r.split():
                    ...
                    # 全局指针标签：如果对话历史中对应位的词存在于答句则标1
                    selector_index = [1 if (word_arr[0] in ent_words or word_arr[0] in r.split()) else 0 for word_arr in
                                      context_arr] + [1]
