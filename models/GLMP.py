...
class GLMP(nn.Module):
    ...
    def train_batch(self, data, clip, reset=0):
        ...
        all_decoder_outputs_vocab, all_decoder_outputs_ptr, \
            _, _, global_pointer = self.encode_and_decode(data, max_target_length, use_teacher_forcing, False)
    ...
    def encode_and_decode(self, data, max_target_length, use_teacher_forcing, get_decoded_words):
        ...
        # decoded_fine：保存经过copy后生成的token。
        # decoded_coarse：保存未使用copy机制时生成的token。
