...
for epoch in range(1000):
    ...
    for i, data in pbar:
        ...
        loss, loss_g, loss_v, loss_l = model.return_loss()
        loss_list[0].append(loss)
        loss_list[1].append(loss_g)
        loss_list[2].append(loss_v)
        loss_list[3].append(loss_l)
...
torch.save(loss_list, 'loss/loss_bsz{}_lr{}'.format(args['batch'], args['learn']))
